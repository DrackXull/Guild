...
- 🧭 Presence radar + “Active now” chips so admins can see who is online or in-game; feeds off `/api/presence/ping` and the optional desktop helper.
- 🧭 Presence radar + sticky headbar showing who is online/in-game plus a Messages dropdown that surfaces run tags, LFG updates, and report mentions for the active actor.
