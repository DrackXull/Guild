...
3. The landing view is a login gate (guild name + handle + member key) with a recruit link. Non-members must first save a recruit profile and then submit an application; they can revisit the recruit link later to see their own status.
